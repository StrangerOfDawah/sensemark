...
Если выделенный фрагмент не является общеупотребительным словом — например, это название, имя, никнейм или опечатка — Sensemark не станет придумывать перевод. Он сообщит об этом и кратко объяснит по написанию и контексту, что это может быть. Если определить не получится, аккуратно укажет, что это, вероятно, имя или название.
